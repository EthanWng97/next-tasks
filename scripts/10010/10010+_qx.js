...
function get_basic(tel) {
  ...
  let basicurl = {
    url:
      "https://mina.10010.com/wxapplet/bind/getIndexData/alipay/alipaymini?user_id=" +
      tel,
    headers: {},
  };
  $task.fetch(basicurl).then(
    (response) => {
...
function get_detail(remainFee, remainTime, tel) {
  ...
  let dataurl = {
    url:
      "https://mina.10010.com/wxapplet/bind/getCombospare/alipay/alipaymini?stoken=&user_id=" +
      tel,
    headers: {},
  };
  $task.fetch(dataurl).then(
    (response) => {
