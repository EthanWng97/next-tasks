...
var leetcodeHost = "https://leetcode.cn";
...
function getDailyQuestion() {
  ...
  const data = JSON.parse(dailyQuestionResponse).data.todayRecord[0];
  ...
  question.sourceLink = leetcodeHost + "/problems/" + question.titleSlug;
  question.solutionLink = question.sourceLink + "/solution";
  getDetails();
}
